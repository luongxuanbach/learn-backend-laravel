...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- CSS -->
        <link href="{{ asset('backend/assets') }}/css/black-dashboard.css?v=1.0.0" rel="stylesheet" />
        <link href="{{ asset('backend/assets') }}/css/theme.css" rel="stylesheet" />
    </head>
    <body class="{{ $class ?? '' }}">
        @auth()
            <div class="wrapper">
        ...
        <script src="{{ asset('backend/assets') }}/js/black-dashboard.min.js?v=1.0.0"></script>
