        ...
        <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="dropdown nav-item">
                    <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                        <div class="photo">
                            <img src="{{ asset('backend/assets') }}/img/anime3.png" alt="{{ __('Profile Photo') }}">
                        </div>
...
{{--                            <a href="{{ route('profile.edit') }}" class="nav-item dropdown-item">{{ __('Profile') }}</a>--}}
                        ...
                        <li class="nav-link">
{{--                            <a href="{{ route('auth.logout') }}" class="nav-item dropdown-item" onclick="event.preventDefault();  document.getElementById('logout-form').submit();">{{ __('Log out') }}</a>--}}
                            <a href="{{ route('auth.logout') }}" class="nav-item dropdown-item">{{ __('Log out') }}</a>
                        </li>
                    </ul>
                </li>
